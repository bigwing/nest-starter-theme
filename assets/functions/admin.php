...
function joints_rss_dashboard_widget() {
	...
	<h4 style="margin-bottom: 0;">
		<a href="<?php echo $item->get_permalink(); ?>" title="<?php echo mysql2date( __( 'j F Y @ g:i a', 'bigwing-nest' ), $item->get_date( 'Y-m-d H:i:s' ) ); ?>" target="_blank">
...
function joints_custom_dashboard_widgets() {
	wp_add_dashboard_widget( 'joints_rss_dashboard_widget', __( 'Custom RSS Feed (Customize in admin.php)', 'bigwing-nest' ), 'joints_rss_dashboard_widget' );
	/*
...
function joints_custom_admin_footer() {
	_e( '<span id="footer-thankyou">Developed by <a href="#" target="_blank">Your Site Name</a></span>.', 'bigwing-nest' );
}
