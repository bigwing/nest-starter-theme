...
class Nest_Social {
	...
	private function init() {
		...
		'bitbucket.org'      => array(
			...
			'class' => 'bitbucket',
			'icon' => 'fa-bitbucket',
			'icon-sign' => 'fa-bitbucket-sign',
		),
		'dribbble.com'       => array(
			'name' => 'Dribbble',
			'class' => 'dribbble',
			'icon' => 'fa-dribbble',
			'icon-sign' => 'fa-dribbble',
		),
		'dropbox.com'        => array(
			'name' => 'Dropbox',
			'class' => 'dropbox',
			'icon' => 'fa-dropbox',
			'icon-sign' => 'fa-dropbox',
		),
		'facebook.com'       => array(
			'name' => 'Facebook',
			'class' => 'facebook',
			'icon' => 'fa-facebook',
			'icon-sign' => 'fa-facebook-sign',
		),
		'flickr.com'         => array(
			'name' => 'Flickr',
			'class' => 'flickr',
		...
		'foursquare.com'     => array(
			...
			'class' => 'foursquare',
			'icon' => 'fa-foursquare',
			'icon-sign' => 'fa-foursquare',
		),
		'github.com'         => array(
			'name' => 'Github',
			'class' => 'github',
			'icon' => 'fa-github',
			'icon-sign' => 'fa-github-sign',
		),
		'gittip.com'         => array(
			'name' => 'GitTip',
			'class' => 'gittip',
		...
		'linkedin.com'       => array(
			...
			'class' => 'linkedin',
			'icon' => 'fa-linkedin',
			'icon-sign' => 'fa-linkedin-sign',
		),
		'mailto:'            => array(
			'name' => 'Email',
			'class' => 'envelope',
			'icon' => 'fa-envelope',
			'icon-sign' => 'fa-envelope-alt',
		),
		'pinterest.com'      => array(
			'name' => 'Pinterest',
			'class' => 'pinterest',
			'icon' => 'fa-pinterest',
			'icon-sign' => 'fa-pinterest-sign',
		),
		'plus.google.com'    => array(
			'name' => 'Google+',
			'class' => 'google-plus',
			'icon' => 'fa-google-plus',
			'icon-sign' => 'fa-google-plus-sign',
		),
		'renren.com'         => array(
			'name' => 'RenRen',
			'class' => 'renren',
